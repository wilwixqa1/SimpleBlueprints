...
PARAM_SETS = {
    ...
    # 5. Severe slope: 15% left-to-right (elevation grade treatment testbed)
    "slope15_l2r": {
        "width": 16, "depth": 12, "height": 4,
        "attachment": "ledger", "beamType": "dropped",
        "joistSpacing": 16, "deckingType": "composite",
        "railType": "fortress", "snowLoad": "moderate", "frostZone": "cold",
        "houseWidth": 40, "houseDepth": 30,
        "slopePercent": 15, "slopeDirection": "left-to-right",
        "hasStairs": False, "deckStairs": [],
        "projectInfo": {"name": "Render Review - 15% L2R Slope",
                        "address": "Test Fixture", "applicant": "S85 Harness"},
    },
    # 6. Zones left + right of the main deck, no stairs (S85 stress request)
    "zones_left_right": {
        ...
        "houseWidth": 40, "houseDepth": 30,
        "zones": [
            {"id": 1, "type": "add", "w": 8, "d": 10, "h": None, "attachTo": 0,
             "attachEdge": "left", "attachOffset": 1, "beamType": "dropped",
             "label": "Left Wing"},
            {"id": 2, "type": "add", "w": 8, "d": 10, "h": None, "attachTo": 0,
             "attachEdge": "right", "attachOffset": 1, "beamType": "dropped",
             "label": "Right Wing"},
        ],
        "hasStairs": False, "deckStairs": [],
    ...
    "zones_stairs_lcr": {
        ...
        "hasStairs": True, "stairLocation": "front", "stairWidth": 4,
        "deckStairs": [
            {"id": 1, "zoneId": 1, "location": "left", "width": 4,
             "template": "straight", "offset": 0, "numStringers": 3,
             "_landsOnZoneId": None},
            {"id": 2, "zoneId": 0, "location": "front", "width": 4,
             "template": "platform", "offset": 0, "numStringers": 3,
             "_landsOnZoneId": None},
            {"id": 3, "zoneId": 2, "location": "right", "width": 4,
             "template": "l-right", "offset": 0, "numStringers": 3,
             "_landsOnZoneId": None},
        ],
        "projectInfo": {"name": "Render Review - L/C/R Stairs on Zones",
                        "address": "Test Fixture", "applicant": "S85 Harness"},
    },
    # 8. Four zones (front zone + L + R + cutout) with four stairs,
    #    including one transitional stair landing on the lower zone
    "zones_four_stairs_four": {
        "width": 24, "depth": 14, "height": 6,
        "attachment": "ledger", "beamType": "dropped",
        "joistSpacing": 16, "deckingType": "composite",
        "railType": "fortress", "snowLoad": "moderate", "frostZone": "cold",
        "houseWidth": 44, "houseDepth": 30,
        "zones": [
            {"id": 1, "type": "add", "w": 8, "d": 10, "h": None, "attachTo": 0,
             "attachEdge": "left", "attachOffset": 2, "beamType": "dropped",
             "label": "Left Wing"},
            {"id": 2, "type": "add", "w": 8, "d": 10, "h": None, "attachTo": 0,
             "attachEdge": "right", "attachOffset": 2, "beamType": "dropped",
             "label": "Right Wing"},
            {"id": 3, "type": "add", "w": 10, "d": 8, "h": 3, "attachTo": 0,
             "attachEdge": "front", "attachOffset": 7, "beamType": "dropped",
             "label": "Lower Landing Zone"},
            {"id": 4, "type": "cutout", "w": 4, "d": 4, "attachTo": 0,
             "attachEdge": "back-left", "attachOffset": 2, "label": "Tree Cutout"},
        ],
        "hasStairs": True, "stairLocation": "front", "stairWidth": 4,
        "deckStairs": [
            {"id": 1, "zoneId": 1, "location": "left", "width": 4,
             ...
             "_landsOnZoneId": None},
            {"id": 2, "zoneId": 0, "location": "front", "width": 4,
             "template": "straight", "offset": -8, "numStringers": 3,
             "_landsOnZoneId": 3},
            {"id": 3, "zoneId": 3, "location": "front", "width": 4,
             "template": "straight", "offset": 0, "numStringers": 3,
             "_landsOnZoneId": None},
            {"id": 4, "zoneId": 2, "location": "right", "width": 4,
             "template": "u-turn", "offset": 0, "numStringers": 3,
             "_landsOnZoneId": None},
        ],
        "projectInfo": {"name": "Render Review - 4 Zones / 4 Stairs",
                        "address": "Test Fixture", "applicant": "S85 Harness"},
    },
}
